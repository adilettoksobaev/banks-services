...
const EditStaff:React.FC<Props> = ({ editOpen, editClickClose, sessionId, positionSuccess, employeeSuccessAction, employeeSuccess, employee }) => {
    ...
    return (
        ...
        >
            ...
            <DialogActions className="modal__actions">
                <Button onClick={editClickClose} color="primary">Отмена</Button>
                <Button 
                    onClick={addEmployee} variant="contained" 
                    color="primary" disableElevation
                    disabled={employeeState.employeeInn.length === 14 ? false : true}>Сохранить</Button>
            </DialogActions>
        </Dialog>
        <PositionsModal 
